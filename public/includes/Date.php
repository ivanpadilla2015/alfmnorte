    ...
    function _is_format_valid($date)
    {
        ...
        if (!empty($regexp)) {
            ...
            if (preg_match($format, preg_replace('/\s/', '', $date), $segments)) {
                ...
                $english_days   = array('Domino','Lunes','Martes','Miercoles','Jueves','Viernes','Sabado');
                $english_months = array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre');
